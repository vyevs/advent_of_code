...
// g.inputStage determines how v is interpreted
// if it's 0, v is the x position
// if it's 1, v is the y position
// if it's 2, v is the tile id
func (g *game) giveInstruction(v int) {
	switch g.inputStage {
	case 0:
